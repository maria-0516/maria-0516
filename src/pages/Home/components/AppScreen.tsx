...
interface MenuIconPros {
  className: string
}

function MenuIcon(props: MenuIconPros) {
  return (
...
interface UserIconPros {
  className: string
}

function UserIcon(props: UserIconPros) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      <path
...
AppScreen.Header = forwardRef(function AppScreenHeader({ children }: AppScreenHeaderProps, ref: React.ForwardedRef<HTMLDivElement>) {
  return (
...
AppScreen.Title = forwardRef(function AppScreenTitle({ children }: AppScreenTitleProps, ref: React.ForwardedRef<HTMLDivElement>) {
  return (
...
AppScreen.Subtitle = forwardRef(function AppScreenSubtitle({ children }: AppScreenSubtitleProps, ref: React.ForwardedRef<HTMLDivElement>) {
  return (
...
AppScreen.Body = forwardRef(function AppScreenBody({ children, className }: AppScreenBodyProps, ref: React.ForwardedRef<HTMLDivElement>) {
  return (
    <div
      ref={ref}
