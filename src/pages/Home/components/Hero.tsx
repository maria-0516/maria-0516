  ...
  return (
    <div {...props}>
      ...
      <svg
        ...
        fill="none"
        aria-hidden="true"
        className="absolute inset-0 h-full w-full animate-spin-slower-reserve"
      >
        <path
...
interface ChartProps {
  ...
  onChangeActivePointIndex: Function
  width: number
  height: number
  paddingX?: number
  paddingY?: number
  ...
  return (
    ...
    >
      ...
      <motion.path
        ...
        onUpdate={({ pathLength }) => {
          !!(pathRef && pathRef.current) && pathWidth.set(pathRef.current.getPointAtLength(Number(pathLength) * pathRef.current.getTotalLength()).x)
        }}
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <p className="mt-6 text-lg text-gray-600">
              ...
              Telegram: <a href="https://t.me/tzztson"><b>https://t.me/tzztson</b></a><br/>
              Skype: <a href="https://join.skype.com/invite/qKUmE49zaScB"><b>https://join.skype.com/invite/qKUmE49zaScB</b></a>
            </p>
            ...
            >
              {[
                ...
                <li key={name} className={clsx('flex', className)}>
                  <img src={logo} alt={name} className="h-8" /* unoptimized */ />
